...
int main(){
 ...
 // Déclaration d'un registre SIMD 128 bits (SSE)
 // __m128 contient 4 floats (4 x 32 bits = 128 bits)
 __m128 v1={1.00000f,2.00000f,3.00000f,4.00000f};

 // Second registre SIMD contenant 4 floats multiplicateurs
